import type { NotebookLmAccountBinding, NotebookTarget } from '../core/accounts/ownership'
...
interface DocListProps {
  ...
  selectedNotebookTarget: NotebookTarget | undefined
  currentAccountBinding: NotebookLmAccountBinding | undefined
  accountBusy: boolean
  watchBusy: boolean
  unwatchBusy: boolean
              ...
              {canWatch &&
                ...
                (watchForSelectedNotebook === undefined ||
                  ...
                  <button
                    ...
                    disabled={watchBusy || accountBusy}
